...
# Second set of NOT qualifiers removed on Jan. 19, 2025
...
qualifiers <- c(qualifiers_7227, qualifiers_7955, qualifiers_224308, qualifiers_3702)

# Write out the list of unique qualifiers
qualifiers <- unique(qualifiers) %>% sort()
write_tsv(as_tibble_col(qualifiers_3702, column_name = "qualifier"), "Desktop/GitHub_Repos/protein-weaver/data/GeneOntology/qualifiers.tsv")
