...
```{r}
bsub_interactome <- left_join(bsub_interactome, p1_dupes, by = "protein_1_locus") %>% mutate(protein_1_name = case_when(
...
bsub_interactome <- left_join(bsub_interactome, p2_dupes, by = "protein_2_locus") %>% mutate(protein_2_name = case_when(
